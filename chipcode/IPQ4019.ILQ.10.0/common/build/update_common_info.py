...
-------------------------------------------------------------------------------
  ...
  $Header: //depot/asic/ipq8066/IPQ4019.ILQ.10.0_P/meta/main/latest/common/build/update_common_info.py#6 $
  $DateTime: 2019/04/04 07:29:58 $
...
#############-------------------GENERATE_LKBOOT_IMAGE-------------------#############
	
   ret_lkboot_emmc_single = lg.log_exec(['python',pack_tool,'-t','emmc','-B' , "--lk" , '-F','boardconfig_premium','-o', bin_dir +'/'+'emmc-ipq40xx-single-lkboot.img',ipq_dir],verbose=0)
   print "ret_lkboot_emmc_single %d." % ret_lkboot_emmc_single
