...
-------------------------------------------------------------------------------
  ...
  $Header: //depot/asic/ipq8066/IPQ8064.ILQ.10.0_P/meta/main/latest/common/build/update_common_info.py#6 $
  $DateTime: 2019/04/02 07:59:08 $
...
#################### ------------------- GENERATE_LKBOOT_IMAGE------------------- ####################
   ...
   ret_lkboot_emmc_single = lg.log_exec(['python',pack_tool,'-t','emmc','-B', '--lk' ,'-F','boardconfig', '-o', bin_dir +'/'+'emmc-ipq806x-single-lkboot.img', ipq_dir],verbose=0)
